    ...
    <nav className="fixed top-0 left-0 w-full h-20 bg-[#0a0a0a] border-b border-white/10 z-[100] flex items-center">
      <div className="max-w-7xl mx-auto w-full flex items-center justify-between px-6 md:px-10">
        ...
        <Link href="/" className="relative flex items-center gap-3 group">
          <div className="relative w-12 h-12 md:w-16 md:h-16">
            <Image
              ...
              fill
              className="object-contain invert brightness-200" // Esto hace el logo blanco
              priority
            />
          </div>
        ...
        <div className="flex items-center">
          <Link href="/products">
            <button className="bg-white text-black px-5 py-2.5 md:px-8 md:py-3 rounded-full text-sm font-semibold transition-all duration-300 hover:bg-stone-200 active:scale-95">
              Ver Productos
            </button>
          </Link>
        </div>
